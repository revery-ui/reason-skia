...
module Path = {
  ...
  [@noalloc] external cubicTo: (t, [@unboxed] float, [@unboxed] float, [@unboxed] float, [@unboxed] float, [@unboxed] float, [@unboxed]float) => unit = "resk_path_cubic_to_byte" "resk_path_cubic_to";
}
