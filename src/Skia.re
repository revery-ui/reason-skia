...
module Path = {
  ...
  external cubicTo:
    ...
    unit =
    "resk_path_cubic_to_byte" "resk_path_cubic_to";
};

module Typeface = {
  type t;

  external makeFromFile: (string, int) => option(t) =
...
module Paint = {
  ...
  [@noalloc]
  external setAntiAlias: (t, bool) => unit = "resk_paint_set_antialias";
  [@noalloc]
  external setLcdRenderText: (t, bool) => unit =
    "resk_paint_set_lcd_render_text";
  [@noalloc]
  external setStyle: (t, PaintStyle.t) => unit = "resk_paint_set_style";
  [@noalloc]
  external setStrokeWidth: (t, float) => unit = "resk_paint_set_stroke_width";
  [@noalloc]
  external setSubpixelText: (t, bool) => unit = "resk_paint_set_subpixel_text";
  [@noalloc]
  external setTextSize: (t, float) => unit = "resk_paint_set_text_size";
  [@noalloc]
  external setTypeface: (t, Typeface.t) => unit = "resk_paint_set_typeface";
};
...
module Canvas = {
  ...
  [@noalloc]
  external drawPaint: (t, Paint.t) => unit = "resk_canvas_draw_paint";
  [@noalloc]
  external drawPath: (t, Path.t, Paint.t) => unit = "resk_canvas_draw_path";
  [@noalloc]
  external drawRect: (t, Rect.t, Paint.t) => unit = "resk_canvas_draw_rect";
  [@noalloc]
  external drawOval: (t, Rect.t, Paint.t) => unit = "resk_canvas_draw_oval";
  [@noalloc]
  external drawText: (t, string, float, float, Paint.t) => unit =
    "resk_canvas_draw_text";
};
